  ...
  <div class="list row">
    ...
    <div class="col-md-6">
      <div v-if="currentVaccine">
        <h4>Vaccine</h4>
        <div>
          <label><strong>Title:</strong></label> {{ currentVaccine.vaccine }}
        </div>
        <div>
          <label><strong>Description:</strong></label> {{ currentVaccine.description }}
        </div>
        <div>
          <label><strong>Status:</strong></label> {{ currentVaccine.published ? "Published" : "Pending" }}
        </div>
